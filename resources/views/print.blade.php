...
<div class="page-sm table">
    <div class="cover-image">
        ...
        <div class="table_content">
            ...
            <img src="{{ public_path($doc->sketching_img) }}" style="width: auto; height: 455px;"/>
        </div>
    </div>
</div>
...
<div class="page-sm table">
    <div class="cover-image">
        ...
        <div class="table_content">
            ...
            <img src="{{ public_path('/uploads/wasefElmawqe3.png') }}" style="width: auto;
    height: 750px;
    position: absolute;
    left: 0;
    right: 0;
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>هي الجهات الحكومية وغير الحكومية ولها علاقة بالمشروع من الناحية التنظيمية، أو الرقابية، أو
                        الفنية، أو التي تقدم الخدمات الأساسية للمشروع.
                    </td>
                </tr>
                <tr>
                    <td>الكراسة</td>
                ...
                <tr>
                    ...
                    <td>الغرض من العقد هو استثمار الموقع الموضحة بياناته أعلاه لإنشاء وإدارة وتشغيل سوق تجاري ولا
                        يجوز استخدامه لغير الغرض المخصصة له.
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>يعطى المستثمر فترة ( ) للتجهيز والإنشاء، وهي تعادل % من المدة المحددة في المادة الخامسة من
                        ...
                        الحالة سداد قيمة عطائه المالي عن هذه الفترة.
                    </td>
                </tr>
            </table>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>5. الحصول على موافقة البلدية على اسم الجهة الاستشارية المكلفة بالإشراف على تنفيذ المشروع،
                        والتأكد من تنفيذه وفقاً للشروط والمواصفات والمخططات المتفق عليها.
                    </td>
                </tr>
                <tr>
                    <td></td>
                ...
                <tr>
                    ...
                    <th>
                        </td>الرقابة على تنفيذ العقد.
                    </th>
                </tr>
                <tr>
                    <td></td>
                    <td>للبلدية والجهات ذات العلاقة الحق في الرقابة على المشروع في أي وقت خلال مدة العقد. ويلتزم
                        الطرف الثاني بجميع تعليمات الجهة المشرفة على التنفيذ المعينة من الطرف الأول.
                    </td>
                </tr>
                <tr>
